    ...
    <?php foreach ($listings as $index => $job) : ?>
      <div class="md my-4">
        <div class="rounded-lg shadow-md <?= 
          $index % 2 === 0 ? "bg-blue-100" : "big-white"
        ?> ">
          <div class="p-4">
            ...
            <ul class="mt-4">
              ...
              <li class="mb-2">
                ...
                <?= 
                  $job["location"] === "New York" ? '<span class="text-xs text-white bg-blue-500 rounded-full px-2 py-1 ml-2">Local</span>' : '<span class="text-xs text-white bg-yellow-500 rounded-full px-2 py-1 ml-2">Remote</span>'
                ?>
              </li>
