  ...
  <div class="container mx-auto p-4 mt-4">
    <div class="md my-4">
      ...
      <form action="delete.php" method="post">
        ...
        <button type="submit" name="submit" class="bg-green-500 text-white px-4 py-2 rounded block w-full text-center mb-4 hover: bg-red-600 focus:outline-none">Delete</button>
      </form>
    </div>
  </div>
</body>
